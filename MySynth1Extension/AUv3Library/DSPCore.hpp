...
public:
  ...
  // virtual int mapParameterCode(const char *identifier,
  //                                   int address) = 0;
  // virtual uint64_t mapParameterCode(const char *identifier) = 0;

  virtual void setParameter(int code, float value) = 0;

  // virtual void prepare(float sampleRate, int maxFrameLength) = 0;
