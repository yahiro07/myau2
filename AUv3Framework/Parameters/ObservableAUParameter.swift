...
public final class ObservableAUParameter: ObservableAUParameterNode {
  ...
  // @MainActor
  // func makeBinding() -> Binding<Float> {
  //   Binding(
  //     get: { self.value },
  //     set: { self.value = $0 }
  //   )
  ...
  //   Binding(
  //     get: { self.value },
  //     set: { new in self.value = new }
  //   )
  // }

  // @MainActor
  // var normalizedBinding: Binding<Float> {
  //   Binding(
  //     get: {
  ...
  //       self.value = self.min + clamped * range
  //     }
  //   )
  // }

  // func makeBoolBinding() -> Binding<Bool> {
  //   Binding(
  //     get: { self.value > 0.5 },
